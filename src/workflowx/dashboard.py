"""ROI Dashboard — generates a self-contained HTML dashboard.

One file. No server. No dependencies. Open it in your browser and see:
- Cumulative time saved
- Weekly savings trend
- Friction trajectory
- Replacement adoption rate

This is the artifact you show someone to prove WorkflowX is working.
"""
