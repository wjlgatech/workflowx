...
- [x] Post-Meeting Debrief — raw notes → structured output + Gmail draft + TASKS.md (`workflowx_meeting_debrief`)
- [x] Pre-Meeting Brief — calendar scan → Gmail/Drive/web context → 1-page cheat sheet (`workflowx_prebrief`, `workflowx_generate_brief`)
- [x] Real-Time Sidebar skeleton — 30s refresh loop, Screenpipe + Whisper, Phase 3 scaffold (`sidebar_agent.py`)
- [x] Consent Guard — enforces two-party consent laws in code, blocks external meetings automatically
- [x] 4 new MCP tools (18 total), 23 new tests — all zero API cost
- [x] Flywheel integration — debriefs feed pre-briefs feed patterns, compounds across meetings
